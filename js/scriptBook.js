...
function getPhotoElement(photo_id){
    return `<div class="slider__element"><img src="/imagen/Book/PhotoSlider/Book-${photo_id}.jpg" alt="IRENE" class="clickable">
    </div>`;
}
...
function getPhotoBook(photo_id){
    return `<div class="photo__elementGrid"><img src="/imagen/Book/PhotoGrid/Book-${photo_id}.jpg" alt="Fotos del book" class="photoB">
    </div>`;
}
/*menú resposive ----------------------------------------------------------------------------------------------------------------------------------*/
...
navLinks.forEach(link => {
    link.addEventListener("click", (event) => {
        ...
        if (targetId === "#information-prices") {
